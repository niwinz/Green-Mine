...
urlpatterns = patterns('',
    ...
    url(r'^project/(?P<pslug>[\w\d\-]+)/issue/(?P<iref>[\w\d]+)/edit/$',
        api.IssueEditApiView.as_view(), name="issue-edit"),
    url(r'^project/(?P<pslug>[\w\d\-]+)/issue/(?P<iref>[\w\d]+)/asociate/$',
        api.IssueAsociateApiView.as_view(), name="issue-asociate"),
    url(r'^project/(?P<pslug>[\w\d\-]+)/issue/(?P<iref>[\w\d]+)/drop/$',
        api.IssueDropApiView.as_view(), name="issue-drop"),
