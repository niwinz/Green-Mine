...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStory.team_requirement'
        db.add_column('greenmine_userstory', 'team_requirement',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectExtras.show_burnup'
        db.add_column('greenmine_projectextras', 'show_burnup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStory.team_requirement'
        db.delete_column('greenmine_userstory', 'team_requirement')

        # Deleting field 'ProjectExtras.show_burnup'
        db.delete_column('greenmine_projectextras', 'show_burnup')
