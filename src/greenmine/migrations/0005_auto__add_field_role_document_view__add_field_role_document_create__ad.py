...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.document_view'
        db.add_column('greenmine_role', 'document_view',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Role.document_create'
        db.add_column('greenmine_role', 'document_create',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Role.document_edit'
        db.add_column('greenmine_role', 'document_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Role.document_delete'
        db.add_column('greenmine_role', 'document_delete',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.document_view'
        db.delete_column('greenmine_role', 'document_view')

        # Deleting field 'Role.document_create'
        db.delete_column('greenmine_role', 'document_create')

        # Deleting field 'Role.document_edit'
        db.delete_column('greenmine_role', 'document_edit')

        # Deleting field 'Role.document_delete'
        db.delete_column('greenmine_role', 'document_delete')
