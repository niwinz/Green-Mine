...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectExtras.show_sprint_burndown'
        db.add_column('greenmine_projectextras', 'show_sprint_burndown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectExtras.show_sprint_burndown'
        db.delete_column('greenmine_projectextras', 'show_sprint_burndown')
    ...
    models = {
        ...
        'greenmine.projectextras': {
            ...
            'show_sprint_burndown': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
