...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectExtras.total_story_points'
        db.add_column('greenmine_projectextras', 'total_story_points',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True),
                      keep_default=False)

        # Deleting field 'Project.fixed_story_points'
        db.delete_column('greenmine_project', 'fixed_story_points')


    def backwards(self, orm):
        # Deleting field 'ProjectExtras.total_story_points'
        db.delete_column('greenmine_projectextras', 'total_story_points')

        # Adding field 'Project.fixed_story_points'
        db.add_column('greenmine_project', 'fixed_story_points',
