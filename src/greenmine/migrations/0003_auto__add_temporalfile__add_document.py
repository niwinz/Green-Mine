...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TemporalFile'
        db.create_table('greenmine_temporalfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attached_file', self.gf('django.db.models.fields.files.FileField')(max_length=1000, null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tmpfiles', to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('greenmine', ['TemporalFile'])

        # Adding model 'Document'
        db.create_table('greenmine_document', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', to=orm['greenmine.Project'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', to=orm['auth.User'])),
            ('attached_file', self.gf('django.db.models.fields.files.FileField')(max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('greenmine', ['Document'])


    def backwards(self, orm):
        # Deleting model 'TemporalFile'
        db.delete_table('greenmine_temporalfile')

        # Deleting model 'Document'
        db.delete_table('greenmine_document')
