...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectExtras.sprints'
        db.add_column('greenmine_projectextras', 'sprints',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProjectExtras.show_burndown'
        db.add_column('greenmine_projectextras', 'show_burndown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Milestone.meta_velocity'
        db.delete_column('greenmine_milestone', 'meta_velocity')

        # Adding field 'Milestone.disponibility'
        db.add_column('greenmine_milestone', 'disponibility',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectExtras.sprints'
        db.delete_column('greenmine_projectextras', 'sprints')

        # Deleting field 'ProjectExtras.show_burndown'
        db.delete_column('greenmine_projectextras', 'show_burndown')

        # Adding field 'Milestone.meta_velocity'
        db.add_column('greenmine_milestone', 'meta_velocity',
                      self.gf('django.db.models.fields.TextField')(default={}, null=True),
                      keep_default=False)

        # Deleting field 'Milestone.disponibility'
        db.delete_column('greenmine_milestone', 'disponibility')
