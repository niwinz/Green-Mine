...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectExtras'
        db.create_table('greenmine_projectextras', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task_parser_re', self.gf('django.db.models.fields.CharField')(default=None, max_length=1000, null=True, blank=True)),
        ))
        db.send_create_signal('greenmine', ['ProjectExtras'])

        # Adding field 'Project.extras'
        db.add_column('greenmine_project', 'extras',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='project', unique=True, null=True, to=orm['greenmine.ProjectExtras']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProjectExtras'
        db.delete_table('greenmine_projectextras')

        # Deleting field 'Project.extras'
        db.delete_column('greenmine_project', 'extras_id')
