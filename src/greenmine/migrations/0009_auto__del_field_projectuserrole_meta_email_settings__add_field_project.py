...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectUserRole.meta_email_settings'
        db.delete_column('greenmine_projectuserrole', 'meta_email_settings')

        # Adding field 'ProjectUserRole.mail_milestone_created'
        db.add_column('greenmine_projectuserrole', 'mail_milestone_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_milestone_modified'
        db.add_column('greenmine_projectuserrole', 'mail_milestone_modified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_milestone_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_milestone_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_userstory_created'
        db.add_column('greenmine_projectuserrole', 'mail_userstory_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_userstory_modified'
        db.add_column('greenmine_projectuserrole', 'mail_userstory_modified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_userstory_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_userstory_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_task_created'
        db.add_column('greenmine_projectuserrole', 'mail_task_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_task_assigned'
        db.add_column('greenmine_projectuserrole', 'mail_task_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_task_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_task_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_question_created'
        db.add_column('greenmine_projectuserrole', 'mail_question_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_question_assigned'
        db.add_column('greenmine_projectuserrole', 'mail_question_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_question_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_question_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_document_created'
        db.add_column('greenmine_projectuserrole', 'mail_document_created',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_document_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_document_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_wiki_created'
        db.add_column('greenmine_projectuserrole', 'mail_wiki_created',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_wiki_modified'
        db.add_column('greenmine_projectuserrole', 'mail_wiki_modified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProjectUserRole.mail_wiki_deleted'
        db.add_column('greenmine_projectuserrole', 'mail_wiki_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectUserRole.meta_email_settings'
        db.add_column('greenmine_projectuserrole', 'meta_email_settings',
                      self.gf('django.db.models.fields.TextField')(default={}, null=True),
                      keep_default=False)

        # Deleting field 'ProjectUserRole.mail_milestone_created'
        db.delete_column('greenmine_projectuserrole', 'mail_milestone_created')

        # Deleting field 'ProjectUserRole.mail_milestone_modified'
        db.delete_column('greenmine_projectuserrole', 'mail_milestone_modified')

        # Deleting field 'ProjectUserRole.mail_milestone_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_milestone_deleted')

        # Deleting field 'ProjectUserRole.mail_userstory_created'
        db.delete_column('greenmine_projectuserrole', 'mail_userstory_created')

        # Deleting field 'ProjectUserRole.mail_userstory_modified'
        db.delete_column('greenmine_projectuserrole', 'mail_userstory_modified')

        # Deleting field 'ProjectUserRole.mail_userstory_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_userstory_deleted')

        # Deleting field 'ProjectUserRole.mail_task_created'
        db.delete_column('greenmine_projectuserrole', 'mail_task_created')

        # Deleting field 'ProjectUserRole.mail_task_assigned'
        db.delete_column('greenmine_projectuserrole', 'mail_task_assigned')

        # Deleting field 'ProjectUserRole.mail_task_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_task_deleted')

        # Deleting field 'ProjectUserRole.mail_question_created'
        db.delete_column('greenmine_projectuserrole', 'mail_question_created')

        # Deleting field 'ProjectUserRole.mail_question_assigned'
        db.delete_column('greenmine_projectuserrole', 'mail_question_assigned')

        # Deleting field 'ProjectUserRole.mail_question_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_question_deleted')

        # Deleting field 'ProjectUserRole.mail_document_created'
        db.delete_column('greenmine_projectuserrole', 'mail_document_created')

        # Deleting field 'ProjectUserRole.mail_document_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_document_deleted')

        # Deleting field 'ProjectUserRole.mail_wiki_created'
        db.delete_column('greenmine_projectuserrole', 'mail_wiki_created')

        # Deleting field 'ProjectUserRole.mail_wiki_modified'
        db.delete_column('greenmine_projectuserrole', 'mail_wiki_modified')

        # Deleting field 'ProjectUserRole.mail_wiki_deleted'
        db.delete_column('greenmine_projectuserrole', 'mail_wiki_deleted')
    ...
    models = {
        ...
        'greenmine.projectuserrole': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail_document_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mail_document_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_milestone_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mail_milestone_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_milestone_modified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_question_assigned': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mail_question_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_question_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_task_assigned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_task_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mail_task_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_userstory_created': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'mail_userstory_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_userstory_modified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_wiki_created': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_wiki_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'mail_wiki_modified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
